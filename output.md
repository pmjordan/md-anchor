...
## 1.1 Changes from Earlier Versions stuff_to_add
...
## 1.2 Document Conventions stuff_to_add

- Naming conventions
- Font colors and styles
- Typographic conventions

## 1.3 Glossary stuff_to_add

<!-- Optional section with suggested subsections -->

### 1.3.1 Definitions of terms stuff_to_add
...
### 1.3.2 Acronyms and Abbreviations stuff_to_add
